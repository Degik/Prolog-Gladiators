...
action(run(OppositeDirection)) :- position(agent, _, AgentX, AgentY), position(enemy, Type, EnemyX, EnemyY), is_close(AgentX, AgentY, EnemyX, EnemyY),
                                  \+ healthy, next_step(AgentX, AgentY, EnemyX, EnemyY, EnemyD), opposite(Direction, OppositeDirection),
                                  safe_direction(AgentX, AgentY, OppositeDirection, OD).
...
action(get_to_weapon(Direction)) :- position(agent, _, AgentX, AgentY), position(enemy, Type, EnemyX, EnemyY), is_close(AgentX, AgentY, EnemyX, EnemyY),
...
action(move(Direction)) :- position(agent, _, AgentX, AgentY), position(apple, comestible, AppleX, AppleY), next_step(AgentX, AgentY, AppleX, AppleY, D),
                           safe_direction(AgentX, AgentY, D, Direction).
...
%   - next step direction is a safe direction
action(move_towards_enemy(Direction)) :- \+ position(apple, comestible, _, _), position(agent, _, AgentX, AgentY), position(enemy, Type, EnemyX, EnemyY),
                                         wields_weapon(agent, Weapon), is_beatable(Type, Weapon), next_step(AgentX, AgentY, EnemyX, EnemyY, D),
                                         safe_direction(AgentX, AgentY, D, Direction).
